...
class FUeLfsRevision : public ISourceControlRevision, public TSharedFromThis<FUeLfsRevision, ESPMode::ThreadSafe>
{
public:
	FUeLfsRevision()
		: RevisionNumber(0)
...
public:
	...
	TSharedPtr<FUeLfsRevision, ESPMode::ThreadSafe> BranchSource;
